<div
    ...
    <div class="col-span-12 lg:col-span-2 img box">
        <img src="{{ asset('storage/' . $cartItem->getVariationImage()) }}" class="max-lg:w-full lg:w-[180px] ">
    </div>
    <div class="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
        <div class="flex items-center justify-between w-full mb-4">
            ...
            <button class="rounded-full group flex items-center justify-center focus-within:outline-red-500"
                wire:click="$dispatchTo('cart', 'cart-item-deleted', { cartItem: {{ $cartItem->id }} })">
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-4">
                <button
                    ...
                    wire:click="handleQuantityChange('decrement')">
                ...
                <button
                    class="group rounded-[50px] border border-gray-200 shadow-sm shadow-transparent p-2.5 flex items-center justify-center bg-white transition-all duration-500 hover:shadow-gray-200 hover:bg-gray-50 hover:border-gray-300 focus-within:outline-gray-300">
                    <svg class="stroke-gray-900 transition-all duration-500 group-hover:stroke-black" width="18"
                        wire:click="handleQuantityChange('increment')" height="19" viewBox="0 0 18 19" fill="none"
